...
\graphicspath{ {./pics/lims/} {./pics/mau/}, {./pics/observer/}, {./pics/acsl/}, {./pics/} {./pics/estcmpr/}}
\usepackage{subfig}
...
\begin{document}
	\include{autoref/title}
	\include{autoref/intro}
	\include{autoref/main}
	\include{autoref/list}
\end{document}
